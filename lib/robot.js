...
Robot.prototype.initRobot = function(opts) {
  ...
  this.commands = {
    create_device: this.createDeviceConnection,
    remove_device: this.removeDeviceConnection
  };
...
Robot.prototype.createDeviceConnection = function(opts, callback){
  console.log(opts);
  var self = this;
...
Robot.prototype.removeDeviceConnection = function(opts, callback){
  console.log(opts);
  var self = this;
